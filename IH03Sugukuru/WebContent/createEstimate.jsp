...
<body>
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="index.jsp">Sugukuru_createEstimate</a>
				</div>
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="ListEstimateServlet">見積書</a></li>
						</ul></li>
				</ul>
  ...
  ================================================== -->
	...
	<div class="col-xs-10" id="main_content">
		<h2>
			<span id="title">見積書作成</span>
		</h2>
		<!-- main area -->
		<div id="main_area">
